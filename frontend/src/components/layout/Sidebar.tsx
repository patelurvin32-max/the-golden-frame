...
const NAV_ITEMS = [
  { path: '/', label: 'Dashboard', icon: '📊', roles: ['super_admin', 'branch_manager', 'staff', 'cashier'] },
  { path: '/tables', label: 'Live Tables', icon: '🎱', roles: ['super_admin', 'branch_manager', 'staff', 'cashier'] },
  { path: '/billing', label: 'Billing', icon: '🧾', roles: ['super_admin', 'branch_manager', 'staff', 'cashier'] },
  { path: '/bookings', label: 'Bookings', icon: '📅', roles: ['super_admin', 'branch_manager'] },
  { path: '/reservations', label: 'Reservations', icon: '🗓️', roles: ['super_admin', 'branch_manager', 'staff', 'cashier'] },
