      ...
      <div className="relative">
        ...
        {showNotif && (
          <>
            ...
            <div className="absolute right-0 top-10 z-50 w-80 rounded-2xl border border-border bg-card shadow-2xl">
              <div className="border-b border-border p-4 flex items-center justify-between">
                <p className="font-semibold text-sm">Notifications</p>
                {unread > 0 && <span className="text-xs text-primary font-medium">{unread} new</span>}
              </div>
