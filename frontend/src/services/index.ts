...
export const reservationService = {
  ...
  checkAvailability: (params: Record<string, string>) => api.get('/reservations/check-availability', { params }),
  getTodayAvailability: (params: Record<string, string>) => api.get('/reservations/today-availability', { params }),
